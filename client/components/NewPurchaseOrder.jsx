...
var getNewPurchaseOrder = function(PurchaseOrderActions) {
        ...
        <Modal show='true' onHide={ this.onHide }>
          ...
          <Modal.Body>
            <form className="form-horizontal">
              <Input type='select' label='Kustannuspaikka' labelClassName='col-xs-3' wrapperClassName='col-xs-9' />
              <Input type='text' label='Tilauksen nimi' labelClassName='col-xs-3' wrapperClassName='col-xs-9'
                help='Anna tilaukselle lyhyt ja käyttökohdetta kuvaava nimi, esim. "Vesilaakso/ympäristöpiste" tai "Kahvila Kuppikunta"' />
            </form>
          </Modal.Body>
          <Modal.Footer>
            <div className='text-center'>
            <Button bsStyle='primary'>Tallenna</Button>
